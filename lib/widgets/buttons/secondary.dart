...
class SecondaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var enabledStyle = ElevatedButton.styleFrom(
      primary: color ?? ZeplinColors.pumpkin_orange,
    ...
    var lineArtStyle = ElevatedButton.styleFrom(
      ...
      onPrimary: ZeplinColors.pumpkin_orange, // textColor
      shadowColor: Colors.transparent,
      elevation: 10,
      ...
      side: const BorderSide(width: 2, color: ZeplinColors.pumpkin_orange),
    );
    return Container(
